...
export const SETTINGS_GROUPS: SettingsNavGroup[] = [
  {
    ...
    items: [
      ...
      {
        label: 'Fleet plans',
        description: 'Reusable business service plans, recurring pricing, repair rates, and enrollment terms.',
        route: '/settings/shop/fleet-plans',
        icon: BadgeDollarSign,
        permission: 'businessAccounts:read',
        keywords: ['fleet', 'business', 'plans', 'subscriptions', 'billing', 'per device', 'contracts'],
      },
    ],
  },
  {
